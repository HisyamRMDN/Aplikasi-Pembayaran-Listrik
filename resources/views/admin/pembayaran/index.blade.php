            ...
            <table class="w-full">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Bulan Bayar</th>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">
                        {{ $pembayarans->where('tanggal_pembayaran', date('Y-m-d'))->count() }}
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">
                        Rp {{ number_format($pembayarans->where('tanggal_pembayaran', date('Y-m-d'))->sum('total_bayar'), 0, ',', '.') }}
                    </p>
                </div>
            </div>
        </div>
