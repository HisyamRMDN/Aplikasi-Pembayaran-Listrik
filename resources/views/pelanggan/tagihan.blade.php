        ...
        <div class="bg-green-50 border border-green-200 rounded-lg p-4">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-lg font-semibold text-green-600">{{ $tagihans->where('status', 'lunas')->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-red-50 border border-red-200 rounded-lg p-4">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-lg font-semibold text-red-600">{{ $tagihans->where('status', 'belum_lunas')->count() }}</p>
                </div>
            </div>
        </div>
    </div>
