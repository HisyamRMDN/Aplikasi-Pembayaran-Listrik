...
<div class="p-6">
    ...
    <div class="mb-8">
        ...
        <div class="mt-2 text-sm text-gray-500">
            ...
            <p>Tarif: {{ $pelanggan->tarif->daya }} VA - Rp {{ number_format($pelanggan->tarif->tarif_per_kwh, 2) }}/kWh</p>
        </div>
    </div>
        ...
        <div class="flex">
            ...
            <div class="ml-3">
                ...
                <div class="mt-2 text-sm text-red-700">
                    <p>Anda memiliki {{ $tagihanBelumLunas }} tagihan yang belum lunas. Silakan lakukan pembayaran segera.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <a href="{{ route('pelanggan.tagihan') }}" class="bg-blue-50 hover:bg-blue-100 border border-blue-200 rounded-lg p-6 text-center transition-colors">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Penggunaan (kWh)</th>
                    </tr>
                </thead>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Bulan/Tahun</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Jumlah Meter</th>
